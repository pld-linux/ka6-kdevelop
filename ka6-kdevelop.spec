...
# Source0-md5:	faeb506835d9c9d097da88bfb51091ce
...
Requires:	Qt6Qt5Compat-devel >= %{qtver}
Requires:	Qt6WebEngine-devel >= %{qtver}
Requires:	kf6-threadweaver-devel >= %{kframever}
Requires:	kf6-ktexteditor-devel >= %{kframever}
